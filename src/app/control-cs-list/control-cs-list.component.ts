...
@Component({
  selector: 'app-control-cs-list',
  templateUrl: './control-cs-list.component.html',
  styleUrls: ['./control-cs-list.component.scss'],
  providers: [ChecklistDatabase]

})
export class ControlCsListComponent implements OnInit {
