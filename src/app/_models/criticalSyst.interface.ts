export interface ICriticalSystem {
    ...
    Structure:String,
    SSEPDetailedDescription:String,
    Security:Boolean,
    SafetyOrImportantToSafety:Boolean,
    EmergencyPlan:Boolean
    SafetyRelated:Boolean
    ImportantToSafety:Boolean
    ExtDescription:String
    SSEPJustification:String
    SSEPDecisionComment:String
    SSEPDecisionDate: Date
    SSEPDecisionBy: String
    SSEPReviewerComment: String
    SSEPReviewDate:Date
    SSEPReviewedBy:String
    SSEPApproverComment: String
    SSEPApprovedDate: Date
    SSEPApprovedBy: String
    Additional_Param_1: string
    Additional_Param_2: string
    Additional_Param_3: string
    Additional_Param_4: string
    Additional_Param_5: string
    Additional_Param_6: string
